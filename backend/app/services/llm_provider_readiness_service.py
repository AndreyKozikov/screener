"""Проверка доступности удалённых LLM перед запуском пайплайна e-disclosure (режим AUTO)."""
...
class LlmProviderReadinessService:
    """Выбор провайдера LLM: явный параметр без пробы или AUTO с пробой удалённых API."""
