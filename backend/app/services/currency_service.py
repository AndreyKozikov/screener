"""Сервис взаимодействия с API Центрального Банка РФ для получения курсов валют.

Обеспечивает автоматизированную инкрементальную загрузку курсов USD, EUR и CNY,
их сохранение в локальное хранилище и предоставление данных для валютной переоценки
активов в скринере.
"""
...
class CurrencyService:
    """Сервис управления валютными курсами.

    Обеспечивает синхронизацию локальной базы данных с официальными курсами ЦБ РФ.
    Поддерживает поиск ближайших доступных курсов на выходные и праздничные дни.

    Attributes:
        _repo (CurrencyrateRepository): Репозиторий для доступа к таблице курсов.
