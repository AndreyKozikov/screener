...
# Директория с JSON/CSV данными (bonds.json, coupons_data.json, zerocupon.csv и т.д.)
...
COUPONS_DATA_PATH: Path = DATA_DIR / COUPONS_DATA_JSON
