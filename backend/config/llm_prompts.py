...
Дата начала размещения облигации на рынке: {placement_date} (это дата, когда облигация была впервые выпущена и начала торговаться на рынке. События до этой даты искать не имеет смысла).
...
- Если в запросе пользователя нет ограничений по времени или период не указан, верни дату начала размещения облигации: {placement_date}.
...
{{
  "expanded_query": "обогащенный поисковый запрос для векторного поиска",
